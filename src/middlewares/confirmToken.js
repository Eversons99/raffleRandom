...
async function confirmToken (req, res, next){
    ...
    //Salvando o dado authorization que veio no header da minha requisição, este dado tem uma parte que confirm se o token é refenrente a minha aplicação ou não, é como se fosse apenas um token
